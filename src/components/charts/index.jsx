  ...
  chartCard(title, subtitle, (
    <ResponsiveContainer width="100%" height={height}>
      <AreaChart data={data} margin={{ top: 5, right: 10, bottom: 0, left: 0 }}>
        ...
        <Tooltip formatter={v => [new Intl.NumberFormat('es-AR', { style: 'currency', currency: 'ARS' }).format(v), yLabel]} />
        <Area type="monotone" dataKey={yKey} stroke="#2563eb" strokeWidth={2} fill="url(#colorRev)" />
      </AreaChart>
    </ResponsiveContainer>
  ));
