      ...
      <aside className={`sidebar ${sidebarOpen ? 'mobile-open' : ''}`}>
        <div className="sidebar-header">
          <div className="logo">
            ...
            {!collapsed && <span className="logo-text">Club Socios</span>}
          </div>
            ...
            <div className="user-menu-wrap">
              <button className="user-btn" onClick={() => setUserMenu(o => !o)}>
                ...
                <div className="hide-mobile">
                  <div style={{ fontWeight: 600, fontSize: 13 }}>{user?.email?.split('@')[0] || 'Usuario'}</div>
              ...
              {userMenu && (
                <div className="user-dropdown">
                  <Link to="/configuracion/cuenta" className="dropdown-item" onClick={() => setUserMenu(false)}>
                    <UserCircle size={14} style={{ marginRight: 6 }} />Mi cuenta
                  </Link>
