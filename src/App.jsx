  ...
  <div>
    ...
    <div className="card">
      <div className="card-body" style={{ padding: 60, textAlign: 'center', color: 'var(--gray-400)' }}>
        ...
        <div style={{ marginTop: 8 }}>Esta página está lista para ser implementada.</div>
      </div>
    </div>
  </div>
);
              ...
              <PrivateRoute>
                <AppLayout>
                  <Routes>
                    ...
                    <Route path="/reports/builder"          element={<Placeholder title="Constructor de informes" />} />
                    ...
                    <Route path="/configuracion/cuenta"     element={<CuentaPage />} />
